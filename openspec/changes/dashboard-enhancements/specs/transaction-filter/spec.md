...
The dropdown options SHALL be generated from the `CATEGORIES` list in `finance/ai/categories.py`. The route handler SHALL import and pass `CATEGORIES` to the template.
